export const ErrorMessageTranslation: Record<string, Record<string, string>> = {
    ko: {
        ...
        'Data is already processed, please refresh.': '데이터가 이미 처리되었습니다. 새로 고칩니다.',
        'You are not unauthorized to use this service': '이 서비스를 사용할 수 없습니다. 권한이 없습니다.',
        'record not found, contact admin': '레코드를 찾을 수 없습니다. 관리자에게 문의하십시오.',
        'customer not found, contact admin': '고객을 찾을 수 없습니다. 관리자에게 문의하십시오.',
        'password change failled, please try again': '비밀번호 변경 실패. 다시 시도하세요.',
        'Could not register the device. Please try again': '장치를 등록할 수 없습니다. 다시 시도하세요.',
        'Login failled, wrong password or optic number': '로그인 실패. 잘못된 비밀번호 또는 광학 번호입니다.',
        'Could not log in. Please try again': '로그인할 수 없습니다. 다시 시도하세요.',
        'Could not find social information. Please register.': '소셜 정보를 찾을 수 없습니다. 등록하세요.',
        'Please confirm your email': '이메일을 확인하세요.',
