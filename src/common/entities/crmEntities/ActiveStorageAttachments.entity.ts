...
@Index('index_active_storage_attachments_uniqueness', ['blobId', 'name', 'recordId', 'recordType'], { unique: true })
...
export class ActiveStorageAttachments {
    ...
    @ManyToOne(() => ActiveStorageBlobs, (activeStorageBlobs) => activeStorageBlobs.activeStorageAttachments)
