...
export class UserInformation {
  ...
  @ManyToOne(
    () => ConsultantCompanies,
    (consultantCompanies) => consultantCompanies.userInformations
  )
  @JoinColumn([{ name: "company_id", referencedColumnName: "id" }])
  company: ConsultantCompanies;

  @ManyToOne(() => Countries, (countries) => countries.userInformations)
  @JoinColumn([
    { name: "company_located_country_id", referencedColumnName: "id" },
  ])
  companyLocatedCountry: Countries;

  @ManyToOne(() => Countries, (countries) => countries.userInformations2)
